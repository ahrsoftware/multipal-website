# Generated by Django 3.2.16 on 2022-10-22 14:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_original', models.ImageField(blank=True, null=True, upload_to='palaeography/documentimages-originals/')),
                ...
                ('meta_created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='documentimage_created_by', to=settings.AUTH_USER_MODEL, verbose_name='created by')),
                ('meta_lastupdated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='documentimage_lastupdated_by', to=settings.AUTH_USER_MODEL, verbose_name='last updated by')),
            ],
            options={
                'ordering': [django.db.models.functions.text.Upper('document__name'), 'id'],
            },
        ),
        migrations.CreateModel(
            name='SlDocumentInk',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pw', models.CharField(blank=True, max_length=1000, null=True)),
                ('sw', models.CharField(blank=True, max_length=1000, null=True)),
                ('cw', models.CharField(blank=True, max_length=1000, null=True)),
                ('cew', models.CharField(blank=True, max_length=1000, null=True)),
                ('l', models.CharField(blank=True, max_length=1000, null=True)),
